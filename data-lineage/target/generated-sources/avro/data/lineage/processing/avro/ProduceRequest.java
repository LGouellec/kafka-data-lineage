...
public class ProduceRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7242840823034652372L;
   ...
   */
  public static data.lineage.processing.avro.ProduceRequest.Builder newBuilder() {
    return new data.lineage.processing.avro.ProduceRequest.Builder();
  }
   ...
   * @return A new ProduceRequest RecordBuilder
   */
  public static data.lineage.processing.avro.ProduceRequest.Builder newBuilder(data.lineage.processing.avro.ProduceRequest.Builder other) {
    if (other == null) {
      return new data.lineage.processing.avro.ProduceRequest.Builder();
    } else {
      return new data.lineage.processing.avro.ProduceRequest.Builder(other);
    }
  }
   ...
   * @return A new ProduceRequest RecordBuilder
   */
  public static data.lineage.processing.avro.ProduceRequest.Builder newBuilder(data.lineage.processing.avro.ProduceRequest other) {
    if (other == null) {
      return new data.lineage.processing.avro.ProduceRequest.Builder();
    } else {
      return new data.lineage.processing.avro.ProduceRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProduceRequest>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(data.lineage.processing.avro.ProduceRequest.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(data.lineage.processing.avro.ProduceRequest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder setMethodName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder clearMethodName() {
      methodName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder setTopic(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder clearTopic() {
      topic = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder setUser(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder clearUser() {
      user = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder setOperation(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder clearOperation() {
      operation = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data.lineage.processing.avro.ProduceRequest.Builder clearClientId() {
      client_id = null;
